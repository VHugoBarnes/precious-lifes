                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('registrar-cuenta') }}">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <input class="input--style-6" type="text" name="numero_cuenta" placeholder="Ej. César Hernández" required>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <input class="input--style-6" type="text" name="banco" placeholder="Ej. César Hernández" required>
                            </div>
                        </div>
